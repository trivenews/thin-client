...
},{"strict-uri-encode":32}],27:[function(require,module,exports){
'use strict';
...
},{"../vendor/TraceKit/tracekit":31,"./configError":27,"./utils":30}],29:[function(require,module,exports){
/**
...
},{"./raven":28}],30:[function(require,module,exports){
'use strict';
...
},{"../../src/utils":30}],32:[function(require,module,exports){
'use strict';
...
function BrowserAction(chromeBrowserAction) {
  ...
  this.update = function (tabId, state) {
    ...
    if (state.state === states.ACTIVE) {
      ...
      title = 'Trive is active';
    } else if (state.state === states.INACTIVE) {
      title = 'Trive is inactive';
    } else if (state.state === states.ERRORED) {
      title = 'Trive failed to load';
      badgeText = '!';
    } else {
...
},{"./settings":45,"./tab-state":47}],35:[function(require,module,exports){
'use strict';
...
},{"./raven":44}],39:[function(require,module,exports){
'use strict';
...
},{"./hypothesis-chrome-extension":41,"./install":42,"./polyfills":43,"./raven":44}],40:[function(require,module,exports){
'use strict';
...
},{"./browser-name":35,"./errors":38}],41:[function(require,module,exports){
'use strict';
    ...
    if (state.isTabActive(tab.id) && !isInstalled) {
      ...
      return sidebar.injectIntoTab(tab, config).then(function () {
        ...
        if (!errors.shouldIgnoreInjectionError(err)) {
          errors.report(err, 'Injecting Trive sidebar', {
            url: tab.url
          });
        }
...
},{"./browser-action":34,"./direct-link-query":37,"./errors":38,"./help-page":40,"./settings":45,"./sidebar-injector":46,"./tab-state":47,"./tab-store":48}],42:[function(require,module,exports){
'use strict';
...
},{"./hypothesis-chrome-extension":41,"./settings":45}],43:[function(require,module,exports){
'use strict';
...
},{"core-js/fn/object/assign":1,"core-js/fn/object/values":2,"whatwg-fetch":33}],44:[function(require,module,exports){
'use strict';
...
},{"raven-js":29}],45:[function(require,module,exports){
'use strict';
...
function SidebarInjector(chromeTabs, dependencies) {
  ...
  function injectIntoRemoteDocument(tab, config) {
    ...
    if (!isSupportedURL(tab.url)) {
      ...
      return Promise.reject(new errors.RestrictedProtocolError('Cannot load Trive into ' + protocol + ' pages'));
    }
      ...
      if (type === CONTENT_TYPE_PDF) {
        ...
        return injectConfig(tab.id, config).then(function () {
          ...
          if (result && typeof result.installedURL === 'string' && result.installedURL.indexOf(extensionURL('/')) === -1) {
            throw new errors.AlreadyInjectedError('Trive is already injected into this page');
          }
        });
      }
    });
...
},{"./detect-content-type":36,"./errors":38,"./util":50,"query-string":26}],47:[function(require,module,exports){
'use strict';
...
},{"./uri-info":49,"is-equal-shallow":24}],48:[function(require,module,exports){
'use strict';
 ...
 */
function query(uri) {
  return fetch(settings.apiUrl + '/badge?uri=' + encodeUriQuery(uri), { credentials: 'include' }).then(function (res) {
    return res.json();
  }).then(function (data) {
...
},{"./settings":45}],50:[function(require,module,exports){
'use strict';
